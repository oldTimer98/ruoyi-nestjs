<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleForceLogout" v-hasPermi="['monitor:online:forceLogout']">
          批量强退
        </el-button>
      </el-col>
...
function handleForceLogout(row) {
  ...
  proxy.$modal
    .confirm('是否确认强退名称为"' + userNames + '"的用户?')
    .then(function () {
